...
monster.loot = {
	...
	{name = "red robe", chance = 100},
	{name = "blue robe", chance = 600},
	{name = "simple dress", chance = 60000},
	{id = 3122, chance = 60000}, -- dirty cape
	{name = "terra mantle", chance = 340},
	{name = "petrified scream", chance = 4150}, -- imbue item / yasir / The Cursed Crystal Quest
	{name = "hair of a banshee", chance = 4810}, -- yasir
	{name = "sweet smelling bait", chance = 40} -- used to tame a Wailing Widow
}

monster.attacks = {
	{name ="melee", interval = 2000, chance = 100, minDamage = 0, maxDamage = -83, condition = {type = CONDITION_POISON, totalDamage = 3, interval = 4000}},
	{name ="combat", interval = 2000, chance = 34, type = COMBAT_LIFEDRAIN, minDamage = -120, maxDamage = -200, radius = 4, effect = CONST_ME_SOUND_RED, target = false},
